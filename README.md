...
Я — студент Омского государственного университета путей сообщения, увлечённый **Data Science** и **Machine Learning**.  
...
- **Классическое ML**: Logistic Regression, Random Forest, Gradient Boosting
...
Ищу **стажировку / junior-позицию** в области:
- Data Science
- Machine Learning Engineer
- Computer Vision / NLP / RL

Готов к интересным задачам, где можно расти и приносить реальную пользу.
...
**⭐ Если проект понравился — ставь звезду!** Буду рад сотрудничеству и новым интересным задачам!
